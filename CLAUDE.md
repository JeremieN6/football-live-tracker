...
### Prochaines etapes :
- [ ] Appliquer la migration `20260911160000_clubs_fixes.sql` (repare les clubs sans equipe + ajoute une contrainte d'unicite sur clubs.owner_id) puis reessayer de creer une equipe dans `/teams`

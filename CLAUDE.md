...
### Prochaines etapes :
- [ ] Appliquer la migration `20260911170000_recreate_club_policies.sql` (les policies RLS de clubs/teams/club_members etaient absentes en prod, `pg_policies` confirmait 0 ligne pour `teams` malgre une migration 140000 reportee comme reussie) puis reessayer de creer une equipe dans `/teams`
- [ ] Appliquer la migration `20260911160000_clubs_fixes.sql` (repare les clubs sans equipe + ajoute une contrainte d'unicite sur clubs.owner_id)
- [ ] Tester en conditions reelles la fondation multi-club (creer une 2e equipe avec division, verifier le filtre/tri par equipe dans l'effectif, creer un match rattache a une equipe, verifier le profil joueur)

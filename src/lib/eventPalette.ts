...
export const EVENT_PALETTE: EventMeta[] = [
  ...
  { type: 'CORNER_AGAINST', label: 'Corner concédé', color: '#FB923C', bg: '#431407', border: '#9a3412', group: 'Défensif' },
  { type: 'FREE_KICK_AGAINST', label: 'Coup franc concédé', color: '#F472B6', bg: '#500724', border: '#9d174d', group: 'Défensif' },
